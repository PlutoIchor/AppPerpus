...

{
    ...
    public function map($anggotas): array
    {
        ...
        return [
            [
                ...
                $this->index++,
                $anggotas->user->username,
                $anggotas->buku->judul,
                $anggotas->tanggal_peminjaman,
                $anggotas->tanggal_pengembalian,
                $anggotas->denda
            ],
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                $event->sheet->setCellValue('B1', 'Laporan Anggota')->getStyle('B1:G1')
                    ->getAlignment()
